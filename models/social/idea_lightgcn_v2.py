...
class IDEA_LIGHTGCN_V2(BaseModel):
    def __init__(self, data_handler):
        super(IDEA_LIGHTGCN_V2, self).__init__(data_handler)
    ...
    def _normalize_trust_matrix(self, trust_mat):
        ...
        """
        if 'not_normalize' in configs['model'] and configs['model']['not_normalize']:
            return trust_mat
    ...
    def get_trust_adj(self, trust_mat, adj, embeds):
        ...
        """
        if 'socially_aware_normalization' in configs['model'] and configs['model']['socially_aware_normalization']:
